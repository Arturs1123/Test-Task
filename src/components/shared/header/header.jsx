          ...
          >
            {MENUS.header.map(({ to, text }, index) => (
              <li key={index} className="inline-block text-[0]">
                <Link
                  className="inline-block text-center text-[18px] before:block before:h-0 before:font-medium before:overflow-hidden before:invisible before:content-[attr(title)]"
                  href={to}
                  theme="default"
                  size="md"
                  title={text}
